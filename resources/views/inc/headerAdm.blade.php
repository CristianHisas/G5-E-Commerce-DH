...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark  barra">
     <!--Comienza el nombre de la empresa-->
         <a class="navbar-brand" href="{{url('/home')}}">
           <img src="{{asset('img/e-com1.png')}}" width="30" height="30" class="d-inline-block align-top logo" alt="">
             ...
             <div class="input-group">
               ...
               <div class="input-group-append">
                 <button class="btn btn-primary" type="button">
                     <img src="{{asset('img/lupa.png')}}" width="20" height="20" class="d-inline-block align-top" alt="">
                 </button>
               </div>
             </div>
           </form>
     ...
     <!--Comienza del menu complimido-->
         ...
         <div class="collapse navbar-collapse " id="navbarNav">
           <ul class="navbar-nav ml-md-auto">
             ...
             <li class="nav-item">
                     <a class="nav-link" href="{{url('faq')}}">Ayuda <img src="{{asset('img/pregunta.png')}}" width="25" height="25" class="d-inline-block align-top ml-auto logo" alt=""></a>
             </li>
           </ul>
         </div>
