  ...
  <!-- Footer ================================================================== -->
        ...
        <div class="row d-flex justify-content-between">
          <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xd-4">
            <h5>ACCOUNT</h5>
            <a href="{{url('login')}}" class="">YOUR ACCOUNT</a>
            <a href="{{url('login')}}">PERSONAL INFORMATION</a>
            <a href="{{url('login')}}">ADDRESSES</a>
            <a href="{{url('login')}}">DISCOUNT</a>
            <a href="{{url('login')}}">ORDER HISTORY</a>
          </div>
          <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xd-4">
            <h5>INFORMATION</h5>
            <a href="{{url('contacto')}}">CONTACT</a>
            <a href="{{url('registro')}}">REGISTRATION</a>
            <a href="{{url('legal_notice.html')}}">LEGAL NOTICE</a>
            <a href="{{url('tac.html')}}">TERMS AND CONDITIONS</a>
