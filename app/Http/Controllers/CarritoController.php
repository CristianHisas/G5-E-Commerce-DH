...
class CarritoController extends Controller
{
  ...
  */
  public function store(Request $request)
  {
    ...
    //Si no existe el usuario se le crea un carrito
    if(!$usuariocarrito){
    ...
    //obtiene array donde cada  elemento de la tabla de detalle Productos(el carrito,el producto,el estado,cantidad a comprar) de un carrito en particular
